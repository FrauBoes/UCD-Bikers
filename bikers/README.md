...
install it (`pip install bikers.tar.gz`), ensure that configuration file exists and
`BIKERS_SETTINGS` environment variable points to it, ensure that user has access to the
